...
import { SettingsMtiPage } from '../settings-mti/settings-mti-page';
import { SettingsRawViewPage } from '../settings-raw-view/settings-raw-view';
...
export class SettingsDevToolsPage {
  ...
  showResetWarning() {
    let promptOptions: AlertOptions = {
      ...
      message:
        'You have performed a Force Sync. Do you need to perform a Reset Application?',
      buttons: [
        {
          text: 'OK',
          handler: data => {
