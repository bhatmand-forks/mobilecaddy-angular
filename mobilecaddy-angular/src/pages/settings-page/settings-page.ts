...
// import { McDiagnosticsPage } from '../../pages/mc-diagnostics/mc-diagnostics'
...
export class SettingsPage implements OnInit {
  ...
  constructor(
    public navCtrl: NavController // private mcPinChallengeProvider: McPinChallengeProvider, // private mcUpgradeProvider: McUpgradeProvider, // private mcSettingsProvider: McSettingsProvider
  ) {}
  ...
  openAdminFunctions() {
    // this.mcPinChallengeProvider.presentPinChallenge(true,30000,true,undefined,undefined).subscribe(result => {
    //   if (result) {
  ...
  openAdminFunctions2() {
    // this.mcPinChallengeProvider.presentPinChallenge(window['LOCAL_DEV'],30000,true,undefined,undefined).subscribe(result => {
  ...
  upgrade() {
    // this.mcUpgradeProvider.upgrade({ignoreRepromptPeriod: true}).subscribe(res => {
    // });
  }
  ...
  pinChallenge1Example() {
    ...
    //   duration: 2000
    // };
    // this.mcPinChallengeProvider.presentPinChallenge(false,0,false,3,undefined,alertOptions,toastOptions).subscribe(result => {
  ...
  pinChallenge2Example() {
    ...
    // //
    // this.mcPinChallengeProvider.presentPinChallenge(false,10000,true,undefined,undefined).subscribe(result => {
